...
//Se comienza el bucle en 2, ya que en la primera iteración se van a imprimir los números 0 y 1 que están recogidos en las variables $num1 y $num2 respectivamente
for($i=2; $i<=10; $i++){ 
    ...
    //Continuación de la sucesión en la iteración 3 (a partir del tercer número a imprimir)
        ...
        $numSuma = $num1 + $num2;   // almacenamos en $numSuma el nuevo número a imprimir de la sucesión
